...
public class ListCheckQuesAdapter extends RecyclerView.Adapter<ListCheckQuesAdapter.ViewHolder> {
    List<Question> list;
    Context context;

    public ListCheckQuesAdapter(List<Question> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(question.getYour_answer() != -1){
            holder.item_list_question.setBackgroundResource(R.drawable.choice);
