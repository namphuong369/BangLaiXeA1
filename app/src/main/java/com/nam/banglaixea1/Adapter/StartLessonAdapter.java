...
public class StartLessonAdapter extends PagerAdapter {
    ...
    public StartLessonAdapter(List<Question> list, Context context) {
        this.list = list;
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        if(qst.getYour_answer()!=NULL){
            if (qst.getYour_answer() == 1) {
                rb1.setTextColor(Color.parseColor("#DFBF2A"));
            } else if (qst.getYour_answer() == 2) {
                rb2.setTextColor(Color.parseColor("#DFBF2A"));
            } else if (qst.getYour_answer() == 3) {
                rb3.setTextColor(Color.parseColor("#DFBF2A"));
            } else if (qst.getYour_answer() == 4) {
                rb4.setTextColor(Color.parseColor("#DFBF2A"));
            }
        }
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.rb1:
                        your_answer = 1;
                       setTextColorRadioButton(rb1,rb2,rb3,rb4);
                        break;
                    case R.id.rb2:
                        your_answer = 2;
                        setTextColorRadioButton(rb2,rb1,rb3,rb4);
                        break;
                    case R.id.rb3:
                        your_answer = 3;
                        setTextColorRadioButton(rb3,rb2,rb1,rb4);
                        break;
                    case R.id.rb4:
                        your_answer = 4;
                        setTextColorRadioButton(rb4,rb2,rb3,rb1);
                        break;
                }
    ...
    private void setTextColorRadioButton( RadioButton rb1, RadioButton rb2, RadioButton rb3, RadioButton rb4) {
        rb1.setTextColor(Color.parseColor("#DFBF2A"));
